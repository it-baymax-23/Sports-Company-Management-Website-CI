    ...
    <div class="card mt-3 mb-3">
      <div class="card-header">
        ...
        <div style="float: right">
          <button class="btn btn-danger delete_all_staff_btn" disabled><i class="fa fa-trash-alt"></i> Delete </button>
        </div>
      </div>
      <div class="card-body">
          ...
          <table class="table table-bordered" id="dataTable1" width="100%" cellspacing="0">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center" style="vertical-align: middle;"><a href="<?php echo base_url()?>backend/staffs/edit_staff/<?php echo $user['id']?>" class="btn blue edit_staff_action" role="button"><i class="fa fa-edit"></i> Edit </a><a href="javascript:;" class="btn red del_staff_action" data-toggle="modal" attr-id="<?php echo $user['id']?>" data-target="#deleteModal"><i class="fa fa-trash-alt"></i> Delete</a></td>
              </tr>
              <?php
                  $index++;
                }
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  ...
                  <a class="btn btn-primary del_staff_btn" href="javascript:;">Delete</a>
                </div>
              </div>
            </div>
          </div>
