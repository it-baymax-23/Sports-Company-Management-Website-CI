                                ...
                                <tr>
                                    <td class="text-center" style="vertical-align: middle;">
                                        <?php
                                          ...
                                          if ($mail['to_user'] == $to_user['id']) { echo $to_user['username']; }
                                        } ?>
                                    </td>
                                    ...
                                    <td class="text-center" style="vertical-align: middle;">
                                        ...
                                        ?>
                                        <span class="badge badge-warning">Unreceive</span>
                                        <?php
                                        } else {
                                        ?>
                                    ...
                                    <td class="text-center" style="vertical-align: middle;">
                                        <a href="<?php echo base_url()?>backend/mails/show_mail/<?php echo $mail['id']?>" role="button" class="btn btn-outline-primary btn-sm">Read</a>
                                        <button type="button" class="btn btn-outline-danger btn-sm del_from_action" attr-id="<?php echo $mail['id']?>" data-toggle="modal" data-target="#remove">Remove</button>
                                    </td>
                                </tr>
                                <?php
                                }
                    ...
                    <div class="modal-dialog modal-sm" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-outline-primary del_from_btn">Confirm</button>
                            </div>
                        </div>
                    </div>
                </div>
